...
class TestROS2InterfaceCLI(unittest.TestCase):
    ...
    def test_show_message(self):
        with self.launch_interface_command(
            arguments=['show', 'ros2interface_test_msgs/msg/ShortVariedMultiNested']
        ) as interface_command:
            assert interface_command.wait_for_shutdown(timeout=2)
        assert interface_command.exit_code == launch_testing.asserts.EXIT_OK
        assert launch_testing.tools.expect_output(
    ...
    def test_show_message_with_all_comments(self):
        with self.launch_interface_command(
            arguments=[
                'show', 'ros2interface_test_msgs/msg/ShortVariedMultiNested', '--all-comments']
        ) as interface_command:
            assert interface_command.wait_for_shutdown(timeout=2)
        assert interface_command.exit_code == launch_testing.asserts.EXIT_OK
        assert launch_testing.tools.expect_output(
    ...
    def test_show_message_with_no_comments(self):
        with self.launch_interface_command(
            arguments=[
                'show', 'ros2interface_test_msgs/msg/ShortVariedMultiNested', '--no-comments']
        ) as interface_command:
            assert interface_command.wait_for_shutdown(timeout=2)
        assert interface_command.exit_code == launch_testing.asserts.EXIT_OK
        assert launch_testing.tools.expect_output(
    ...
    def test_show_service(self):
        with self.launch_interface_command(
            arguments=['show', 'ros2interface_test_msgs/srv/ShortVariedMultiNested']
        ) as interface_command:
            assert interface_command.wait_for_shutdown(timeout=2)
        assert interface_command.exit_code == launch_testing.asserts.EXIT_OK
        assert launch_testing.tools.expect_output(
    ...
    def test_show_service_with_all_comments(self):
        with self.launch_interface_command(
            arguments=[
                'show', 'ros2interface_test_msgs/srv/ShortVariedMultiNested', '--all-comments']
        ) as interface_command:
            assert interface_command.wait_for_shutdown(timeout=2)
        assert interface_command.exit_code == launch_testing.asserts.EXIT_OK
        assert launch_testing.tools.expect_output(
    ...
    def test_show_service_with_no_comments(self):
        with self.launch_interface_command(
            arguments=[
                'show', 'ros2interface_test_msgs/srv/ShortVariedMultiNested', '--no-comments']
        ) as interface_command:
            assert interface_command.wait_for_shutdown(timeout=2)
        assert interface_command.exit_code == launch_testing.asserts.EXIT_OK
        assert launch_testing.tools.expect_output(
    ...
    def test_show_action(self):
        with self.launch_interface_command(
            arguments=['show', 'ros2interface_test_msgs/action/ShortVariedMultiNested']
        ) as interface_command:
            assert interface_command.wait_for_shutdown(timeout=2)
        assert interface_command.exit_code == launch_testing.asserts.EXIT_OK
        assert launch_testing.tools.expect_output(
    ...
    def test_show_action_with_all_comments(self):
        with self.launch_interface_command(
            arguments=[
                'show', 'ros2interface_test_msgs/action/ShortVariedMultiNested', '--all-comments']
        ) as interface_command:
            assert interface_command.wait_for_shutdown(timeout=2)
        assert interface_command.exit_code == launch_testing.asserts.EXIT_OK
        assert launch_testing.tools.expect_output(
    ...
    def test_show_action_with_no_comments(self):
        with self.launch_interface_command(
            arguments=[
                'show', 'ros2interface_test_msgs/action/ShortVariedMultiNested', '--no-comments']
        ) as interface_command:
            assert interface_command.wait_for_shutdown(timeout=2)
        assert interface_command.exit_code == launch_testing.asserts.EXIT_OK
        assert launch_testing.tools.expect_output(
